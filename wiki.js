 ...
 $("button").click(function(){
  ...
  function(data){
    ...
    $(".1").html(result);
      ...
      $(".1").html("<div class='text-justify'>"+"<p>"+data[1][0]+"</p>"+"<br>"+"<h4>"+"Sorry , No description found!"+"</h4>"+"<br>"+"<h3 id='readMore'>"+"<a id ='access' href="+data[3][0]+" target='_blank'>Click for full read</a>"+"</h3>"+"</div>");
    }
    if(data[2][1])
      {
    ...
    $(".2").html(result);
      ...
      {
       $(".2").html("<div class='text-justify'>"+"<p>"+data[1][1]+"</p>"+"<br>"+"<h4>"+"Sorry , No description found!"+"</h4>"+"<br>"+"<h3 id='readMore'>"+"<a id ='access' href="+data[3][1]+" target='_blank'>Click for full read</a>"+"</h3>"+"</div>");
      }
    if(data[2][2])
      {
    ...
    $(".3").html(result);
      ...
      $(".3").html("<div class='text-justify'>"+"<p>"+data[1][2]+"</p>"+"<br>"+"<h4>"+"Sorry , No description found!"+"</h4>"+"<br>"+"<h3 id='readMore'>"+"<a id ='access' href="+data[3][2]+" target='_blank'>Click for full read</a>"+"</h3>"+"</div>");
    }
       if(data[2][3])
      {
    ...
    $(".4").html(result);
      ...
      $(".4").html("<div class='text-justify'>"+"<p>"+data[1][3]+"</p>"+"<br>"+"<h4>"+"Sorry , No description found!"+"</h4>"+"<br>"+"<h3 id='readMore'>"+"<a id ='access' href="+data[3][3]+" target='_blank'>Click for full read</a>"+"</h3>"+"</div>");
    }
       if(data[2][4])
      {
    ...
    $(".5").html(result);
      ...
      $(".5").html("<div class='text-justify'>"+"<p>"+data[1][4]+"</p>"+"<br>"+"<h4>"+"Sorry , No description found!"+"</h4>"+"<br>"+"<h3 id='readMore'>"+"<a id ='access' href="+data[3][4]+" target='_blank'>Click for full read</a>"+"</h3>"+"</div>");
    }
       if(data[2][5])
      {
    ...
    $(".6").html(result);
      ...
      {
        $(".6").html("<div class='text-justify'>"+"<p>"+data[1][5]+"</p>"+"<br>"+"<h4>"+"Sorry , No description found!"+"</h4>"+"<br>"+"<h3 id='readMore'>"+"<a id ='access' href="+data[3][5]+" target='_blank'>Click for full read</a>"+"</h3>"+"</div>");
      }
       if(data[2][6])
      {
    ...
    $(".7").html(result);
      ...
      $(".7").html("<div class='text-justify'>"+"<p>"+data[1][6]+"</p>"+"<br>"+"<h4>"+"Sorry , No description found!"+"</h4>"+"<br>"+"<h3 id='readMore'>"+"<a id ='access' href="+data[3][6]+" target='_blank'>Click for full read</a>"+"</h3>"+"</div>");
    }
       if(data[2][7])
      {
    ...
    $(".8").html(result);
      ...
      $(".8").html("<div class='text-justify'>"+"<p>"+data[1][8]+"</p>"+"<br>"+"<h4>"+"Sorry , No description found!"+"</h4>"+"<br>"+"<h3 id='readMore'>"+"<a id ='access' href="+data[3][8]+" target='_blank'>Click for full read</a>"+"</h3>"+"</div>");
    }
       if(data[2][8])
      {
    ...
    $(".9").html(result);
      ...
      $(".9").html("<div class='text-justify'>"+"<p>"+data[1][8]+"</p>"+"<br>"+"<h4>"+"Sorry , No description found!"+"</h4>"+"<br>"+"<h3 id='readMore'>"+"<a id ='access' href="+data[3][8]+" target='_blank'>Click for full read</a>"+"</h3>"+"</div>");
    }
       if(data[2][9])
      {
  var result ="<div class='text-justify'>"+"<p>"+data[1][9]+"</p>"+"<br>"+"<h4>"+data[2][9]+"</h4>"+"<br>"+"<h3 id='readMore'>"+"<a id ='access' href="+data[3][9]+" target='_blank'>Click for full read</a>"+"</h3>"+"</div>";
    $(".10").html(result);
      ...
      $(".10").html("<div class='text-justify'>"+"<p>"+data[1][9]+"</p>"+"<br>"+"<h4>"+"Sorry , No description found!"+"</h4>"+"<br>"+"<h3 id='readMore'>"+"<a id ='access' href="+data[3][9]+" target='_blank'>Click for full read</a>"+"</h3>"+"</div>");
    }
  });
  });
});
